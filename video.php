...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-0 pe-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="" class="btn btn-primary px-3 d-none d-lg-block">Espace client</a>
        </div>
    </nav>
    <!-- Navbar End -->
    ...
    <section class="presentation first">
        <div class="product-presentation">
            ...
            <div class="small-images">
                <div class="small">
                    <img
                        src="img/camesurv2.jpeg"
                    />
                </div>
                <div class="small">
                    <img
                        src="img/camsur1.jpeg"
                    />
                </div>
                <div class="small">
                    <img
        ...
        <div class="image-presentation">
            <img
                src="img/camsurv.jpeg" width="800" height="400"
            />
        </div>
    ...
    <section class="presentation first">
        <div class="product-presentation">
            ...
            <div class="small-images">
                <div class="small">
                    <img
                        src="img/cameraidm.jpg"
                    />
                </div>
                <div class="small">
                    <img
                        src="img/surveillance.jpeg"
                    />
                </div>
                <div class="small">
                    <img
        ...
        <div class="image-presentation">
            <img
                src="img/VIDS.PNG" width="800" height="400"
            />
        </div>
    ...
    <div class="container-fluid copyright bg-dark py-4">
        <div class="container text-center">
            <p class="mb-2">Copyright &copy; <a class="fw-semi-bold" href="dimanyaworld.com">dimanyaworld.com</a>, Tous droits réservés.</p>
            <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
            <p class="mb-0">
                Conçu par <a class="fw-semi-bold" href="https://dimanyaworld.com">Nadar Tech</a></p>
        </div>
    </div>
    <!-- Copyright End -->
